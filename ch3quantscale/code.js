...
var extent = d3.extent(data.map(weierstrass));
...
var line2 = line1.y(function(d) {return identity(weierstrass(d)); });
...
var line3 = line1.y(function(d) {return power(weierstrass(d)); });
...
var line4 = line1.x(function(d) {return d > 0 ? log(d):0; }).y(function(d) {return linear(weierstrass(d)); });
...
var line5 = line1.x(x).y(function(d) {return quantize(weierstrass(d));});
var offset = 100;
...
var line6 = line1.x(x).y(function(d) {return threshold(weierstrass(d)); });
